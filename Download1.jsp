    ...
    <div id="templatemo_right_column">
      ...
      <div id="templatemo_content_wrapper">
		...
		%>
            ...
            <p class="style8 style2">File Doesn't Exist !!!</p>
            </p>
            <br />
		...
		%>
            ...
            <p class="style8 style2">File Name / Secret Key Mismatch  !!!</p>
            <p class="style8 style2">You Are An Attacker !!! Now U R Under Revokation</p>
            </p>
            <br />
            <p><a href="Download.jsp">Back</a></p>
            <%
